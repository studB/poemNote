...
public class CreateTest {
    ...
    @Test
    void poemCreateTest() throws Exception {
        ...
        mockMvc
            ...
            .andExpect(mrm.jsonPath("$.data.result.Action", is("Write")))
    ...
    @Test
    void TheoryCreateTest() throws Exception {
    ...
    @Test
    void OpinionCreateTest() throws Exception {
    ...
    @Test
    void LineCreateTest() throws Exception {
